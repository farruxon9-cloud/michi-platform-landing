const translations = {
    ...
    ja: {
        ...
        nav_companies: "企業向け",
        nav_join: "参加登録",
        hero_badge: "日本No.1の物流プラットフォーム",
        hero_title: "日本であなたの<span class='gradient-text'>道</span>を見つける",
        hero_desc: "信頼できるドライバーと日本全国のトップ物流企業をつなぐ究極のプラットフォーム。シンプルで迅速、そして透明性が高い。",
        hero_btn_find: "仕事を探す",
        hero_btn_hire: "ドライバーを採用する",
        stat_1: "求人案件",
        stat_2: "登録企業",
        stat_3: "サポート体制",
        ...
        bigstat_1: "10,000人以上のアクティブドライバー",
        bigstat_2: "500社以上のトップ企業",
        bigstat_3: "1つの統合プラットフォーム",
        showcase_title: "手の中で最高の体験を",
        showcase_desc: "私たちのアプリはシンプルさとスピードを念頭に設計されています。面倒な書類手続きなしで、一流の物流企業と直接つながります。",
        badge1_title: "新しいマッチ！",
        badge1_desc: "東京ロジスティクス",
        badge2_title: "¥450,000",
        badge2_desc: "月給",
        badge3_title: "スピード採用",
        badge3_desc: "ワンタップで応募",
        feature1_title: "1. 仕事を見つける",
        feature1_desc: "希望の条件、免許の種類、勤務地に基づいて、日本全国の何千ものドライバーの仕事から検索できます。",
        ...
        investor_page_title: "Michi (道) - 投資家情報",
        nav_investors: "投資家向け",
        nav_pitch: "ピッチブックを入手",
        inv_hero_badge: "独占的投資機会",
        inv_hero_title: "日本の物流の<span class='gradient-text'>未来に投資する</span>",
        inv_hero_desc: "Michiは、日本の物流企業とドライバーのために設計された、低リスクでインパクトの大きいデジタルエコシステムです。比類のない財務安定性を提供する強固な不動産資産に裏付けされています。",
        inv_hero_btn_pitch: "ピッチデックを請求",
        inv_hero_btn_learn: "詳細はこちら",
        inv_about_title: "プラットフォーム構想",
        inv_convenience_title: "すべての利便性を1つのアプリに",
        inv_convenience_desc1: "Michiは、日本全国のドライバーが必要とするすべての重要な機能や利便性を1つの包括的なモバイルスーパーアプリに統合します。求人マッチングからフリートの最適化まで、道路上に直接的な効率性をもたらします。",
        inv_convenience_desc2: "採用仲介業者を排除することで、フリート（車両保有企業）のコストを削減しながら、アクティブな労働力の日雇い収入と柔軟性を最大化します。",
        inv_feat1_title: "求人情報とアルバイト",
        inv_feat1_desc: "日本全国のドライバーのアルバイトおよび正社員求人情報への即時アクセス。",
        inv_feat2_title: "自動車整備の予約",
        inv_feat2_desc: "車検や整備を事前にオンライン予約し、待ち時間を完全に解消します。",
        inv_feat3_title: "対話型AIアシスタント",
        inv_feat3_desc: "ドライバーは、安全なハンズフリーの対話型会話を使用して、すべてのアプリ機能を操作できます。",
        inv_feat4_title: "オフラインナビゲーション",
        inv_feat4_desc: "様々な車両サイズや積載量に最適化されたオフライン・オンラインGPS地図機能。",
        inv_guarantee_title: "80%の元本保証付き低リスク投資",
        inv_guarantee_desc: "Michiは、極めて安全な投資モデルを提供します。初期開発および運営費用は、International Halal Capital Groupの不動産資産から得られる堅実な賃貸収入によって裏付けられています。安定したキャッシュフローで費用がカバーされるため、万が一プロジェクトが失敗した場合でも、投資家の元本の少なくとも80%を安全に返還することを保証します。この独自の構造により、リスク軽減の面で完全に比類のないプラットフォームとなっています。",
        inv_logistics_title: "物流企業との強力なパートナーシップ",
        inv_partner_title: "最重要の投資ターゲット",
        inv_partner_desc: "物流企業は、私たちの最も不可欠なパートナーであり、主要な投資家です。現在の日本の経済環境では、貨物輸送の需要が高まる一方で、ドライバー不足が深刻化しています。フリート運営者は今すぐ労働力を確保する必要があります。",
        inv_talent_title: "新規人材の誘致と育成",
        inv_talent_desc: "当社のプラットフォームは、業界に新しい人材を呼び込むことでこの問題に対処します。運転に関心を示す一般の人々や未経験の若手候補者を惹きつけ、トレーニングを提供し、物流企業とマッチングさせることで、採用危機を解決します。",
        inv_form_title: "ピッチデックと財務モデルの請求",
        inv_form_desc: "バリュエーション、財務予測、成長計画への独占的なアクセスを入手してください。ビジネス詳細を入力してください。",
        inv_form_select_opt: "投資範囲 (USD)",
        inv_form_btn: "リクエストを送信"
    }
};
